...
def calculateTrafficJam(vehID, edgeID, tlss):
    ...
    edgeLength= 420#185.6 #should be done automatically
    max_distance2= -1
...
def singleRun(run, evRoute):
    net = sumolib.net.readNet("corridor\\corridor500.net.xml") #sumonet.NetReader()
    ...
    print sumoExe
    sumoConfig = "corridor\\run500.sumocfg"
	#--step-length 0.1
